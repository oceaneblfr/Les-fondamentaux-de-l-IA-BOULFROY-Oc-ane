...
print("=== ÉTAPE 2 : PRÉPARATION DES DONNÉES (CAS A - CHURN CLIENTS) ===")
...
print(f"Taux de churn : {y.mean()*100:.1f}% -> dataset déséquilibré")
...
# On choisit Logistic Regression ou XGBoost car F1-macro est similaire, prenons XGBoost
...
plt.title("SHAP — Top 15 variables les plus influentes (classe Churn=Yes)")
plt.tight_layout()
plt.savefig('shap_summary.png', bbox_inches='tight')
plt.close()

print("Script terminé. Graphiques générés.")
